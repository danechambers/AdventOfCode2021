...
public static class Day4Extensions
{
    ...
    public static IEnumerable<BingoWinner> FindWinningBoard(
        ...
        int bingoSquareLength)
    {
        ...
        {
            var (update, winner) = bingoNumber.GetFirstWinner(gameBoards, bingoSquareLength);
            gameBoards = update;
    ...
    public static (ImmutableArray<GameBoard> GamBoards, BingoWinner? Winner) GetFirstWinner(
        ...
        int bingoSquareLength)
    {
        ...
        if (result.LowestBreakIteration.HasValue)
        {
            ...
            return (gameBoards, new(bingoNumber, gameBoards[breakIndex]));
        }

        return (gameBoards, null);
    }

    public static int CalculateAnswer(BingoWinner data)
    {
